...
<head>
    ...
    <title>Contact Vault | Add Contacts</title>
...
<body>
    ...
    <div class="container mt-5">
        <form class="form-horizontal" role="form" method="post"
            action="http://localhost/GetMyContact/backends/addContacts.php" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="text-center">
                        <img id="previewImg" src="../img/avatar.jpg" class="avatar img-fluid img-circle img-thumbnail"
                            alt="avatar">
